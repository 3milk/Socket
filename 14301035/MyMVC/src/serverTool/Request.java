...
public class Request implements HttpServletRequest{//ServletRequest {
	...
	static private Map<String,String> mapAttributes;
...
/////////////////////////////////////////////////
	...
	public void setAttribute(String key, Object value) {
		mapAttributes.put(key, (String) value);
		System.out.println("Request: setAttribute: " + key + "||" + value + "||" + mapAttributes.get(key));
	}
